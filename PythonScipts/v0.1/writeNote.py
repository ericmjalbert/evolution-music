...
#             f         -> file pointer
#   Output  : f will have written the midiNote to the file in an 
#             appropriate format 
#----------------------------------------------------------------------
...
#----------------------------------------------------------------------
#   Input   : 4-bit integer (0-127), duration word of the note
#   Output  : float representation of the duration. 
#----------------------------------------------------------------------
